...
#[no_mangle]
pub extern "stdcall" fn blowfish_encrypt(data_ptr: *const u16, key_ptr: *const u16, iv_ptr: *const u16, mode_ptr: *const u16, padding_ptr: *const u16) -> *const u16 {
...
/// inputs, outputs in base64
#[no_mangle]
pub extern "stdcall" fn blowfish_decrypt(data_ptr: *const u16, key_ptr: *const u16, iv_ptr: *const u16, mode_ptr: *const u16, padding_ptr: *const u16) -> *const u16 {
    let data = cstring::from_ptr(data_ptr).unwrap();
    let key = cstring::from_ptr(key_ptr).unwrap();
    let iv = cstring::from_ptr(iv_ptr).unwrap();
    let mode = cstring::from_ptr(mode_ptr).unwrap();
