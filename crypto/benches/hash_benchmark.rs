use std::{mem, ffi::{OsStr, OsString}, iter::once, os::windows::prelude::{OsStrExt, OsStringExt}};
...
pub fn hash_benchmark(c: &mut Criterion) {
    let func: libloading::Symbol<unsafe extern "system" fn(PWSTR, PWSTR) -> PWSTR>;
    let lib: Library;
    unsafe {
